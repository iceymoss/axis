...
import (
	...
	testdata "github.com/iceymoss/axis/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/iceymoss/axis/framework/gin.handlerNameTest$", c.HandlerName())
}
